...
class DataIngestion:
    ...
    def export_data_as_dataFrame(self):
        try:
            ...
            if df.empty:
                raise ValueError(
                    f"No records found in MongoDB collection '{collection_name}' of database '{database_name}'."
                )
    ...
    def split_data_as_train_test(self,dataframe: pd.DataFrame):
        try:
            if dataframe.empty:
                raise ValueError("Cannot split an empty dataframe; ensure source data is loaded.")
